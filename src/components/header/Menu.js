    ...
    <MenuPage>
      ...
      <Link style={LinkStyle} to='/copperrepipepage/'>
        <MenuItem style={{ color: Colors.MainRed }}>
          ...
          Copper Repipe<br/> For Le<Green>$$</Green>
          </CTA>
        </MenuItem>
      </Link>
      ...
      <Link style={LinkStyle} to='/'>
        <MenuItem><img src='https://res.cloudinary.com/dnsdvh13n/image/upload/v1539197672/johnNelsonPlumbing/icons/logo.png' alt='john nelson plumbing smiley face logo'/></MenuItem>
      </Link>
    </MenuPage>
