  ...
  <ContactPage>
    ...
    <Form name="contact" method="post" data-netlify="true">
      ...
      <FormInput>
        ...
        <Input type='tel' id='phone' name='user_phone' placeholder='Phone' required></Input>
      </FormInput>
      <FormInput>
        <FormLabel for='City'>City</FormLabel>
        <Input type='text' id='city' name='user_city' placeholder='City' required></Input>
      </FormInput>
      <FormInput>
        <FormLabel for='e-mail'>E-mail</FormLabel>
        <Input type='email' id='email' name='user_email' placeholder='E-mail' required></Input>
      </FormInput>
      ...
      <HomeInfo>
        ...
        <input id='square-footage' name='square-footage' type='number' placeholder='Square Footage' min='100' max='100000' required/>
      </HomeInfo>
      <HomeInfo>
        <label for='year'>Year Built: </label>
        <input name='year' id='year' type='number' placeholder='Year Built' min='1900' max='9999' required/>
      </HomeInfo>
      <HomeInfo>
      ...
      <FormMsg>
        ...
        <FormMsgInput id='msg' name='user_message' placeholder='Notes..'></FormMsgInput>
      </FormMsg>
      <CTA>
...
const CardDropShadow = '0px 2px 2px rgba(0, 0, 0, 0.25)';
